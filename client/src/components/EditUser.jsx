      ...
      <form onSubmit={handleSubmit} className="addNews__form">
        <div>
          ...
          <span >
            ...
            <h2 classname="addNews__label">Зураг сонгох</h2>
        ...
        <h2 classname="addNews__label">Хэрэглэгчийн нэр:</h2>
        <input
        ...
        <button type="submit" className="btn btn--primary addNews__btn" >Шинэчлэх</button>
      </form>
    </div>
  );
};
