...
const Register = () => {
  ...
  useEffect(() => {
    if (localStorage.getItem("firstLogin")) history.push("/");
  }, [history]);
  ...
  const handleSubmit = async (e) => {
    ...
    if (isLength(password))
      return setUserData({
        ...userData,
        err: "6-гаас их урттай нууц үг оруулна уу.",
        success: "",
      });
    ...
    if (!isMatch(password, cpassword))
      return setUserData({
        ...userData,
        err: "Ижилхэн нууц үгүүд оруулна уу.",
        success: "",
      });
      ...
      <main className="reg__main">
        ...
        <form className="reg__form" onSubmit={handleSubmit}>
          ...
          <input
            ...
            value={password}
          />
          <label className="reg__label" htmlFor="cpassword">
