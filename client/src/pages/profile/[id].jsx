    ...
    return (
        <div className="user__con">
            <div className="user__container">
                ...
                <h2 >Created {moment(user.createdAt).fromNow()}</h2>
                </div>
                <button className="homecard__btn" onClick={() => setEditUser(true)}>Засварлах</button>
                {
                    editUser && <EditUser setEditUser={setEditUser} userInfo={user}/>
                }
            </div>
            <div className="saved__container">
                <h2 className="saved__title">Хадгалсан мэдээнүүд:</h2>
                {
                    len === 0
                    ? <h2 className="no__savednews">Хадгалсан мэдээ алга</h2>
                    : saveNews.map(news => (
